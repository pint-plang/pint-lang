...
public class TypeChecking
{
    public static void main(String[] args) throws IOException {
        ...
        file.accept(new NormalVisitor(System.err, new ParseTreeWalker()));
        System.out.println();
        ...
        for (var v : vars) {
            ...
            if (!(vFlow instanceof ExprEvalControlFlow.Finish vFinish)) {
                if (vFlow instanceof ExprEvalControlFlow.Return) throw new BadJumpException("Returned from variable definition");
                else if (vFlow instanceof ExprEvalControlFlow.Labeled vLabeled) throw new BadJumpException(vLabeled.label() != null ? "Missing label '" + vLabeled.label() + "' (did you make a typo?)" : "Unlabeled jump outside of any loop");
